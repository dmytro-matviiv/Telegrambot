...
MASS_ALERT_THRESHOLD = 2    # Мінімальна кількість міст для масової тривоги
MASS_ALERT_TIME_WINDOW = 1  # Часовий вікно в хвилинах для групування тривог
MASS_END_THRESHOLD = 2      # Мінімальна кількість міст для масового відбою
MASS_END_TIME_WINDOW = 1    # Часовий вікно в хвилинах для групування відбоїв

# Налаштування накручування переглядів (ВІДКЛЮЧЕНО)
VIEWS_BOOST_ENABLED = False  # Відключено - не працює