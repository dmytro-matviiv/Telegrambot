...
# ID групи (новини будуть публікуватися тільки тут)
CHANNEL_ID = os.getenv('CHANNEL_ID', '@GlobalNOChat')
# ID чату в групі (тільки для залучення аудиторії - опитування, дискусії)
...
MASS_ALERT_THRESHOLD = 3    # Мінімальна кількість міст для масової тривоги
MASS_ALERT_TIME_WINDOW = 2  # Часовий вікно в хвилинах для групування тривог
MASS_END_THRESHOLD = 3      # Мінімальна кількість міст для масового відбою
MASS_END_TIME_WINDOW = 2    # Часовий вікно в хвилинах для групування відбоїв

# Налаштування накручування переглядів
VIEWS_BOOST_ENABLED = True  # Увімкнути накручування переглядів
VIEWS_BOOST_INTERVAL = 1800  # Інтервал накручування в секундах (30 хвилин)
VIEWS_BOOST_MIN_VIEWS = 10   # Мінімальна кількість переглядів за раз
VIEWS_BOOST_MAX_VIEWS = 50   # Максимальна кількість переглядів за раз
VIEWS_BOOST_MAX_POST_AGE = 24  # Максимальний вік поста в годинах для накручування
VIEWS_BOOST_MAX_CURRENT_VIEWS = 1000  # Максимальна кількість поточних переглядів для накручування

# Налаштування проксі для накручування
PROXY_ENABLED = True  # Увімкнути використання проксі
PROXY_FILE = "proxies.txt"  # Файл з проксі серверами
PROXY_TEST_INTERVAL = 3600  # Інтервал тестування проксі в секундах (1 година)
PROXY_TIMEOUT = 10  # Таймаут для тестування проксі в секундах
PROXY_ROTATION_INTERVAL = 10  # Зміна проксі кожні N запитів