...
VIEWS_BOOST_INTERVAL = 300   # Інтервал накручування в секундах (5 хвилин)
VIEWS_BOOST_MIN_VIEWS = 3    # Мінімальна кількість переглядів за раз
VIEWS_BOOST_MAX_VIEWS = 10   # Максимальна кількість переглядів за раз
